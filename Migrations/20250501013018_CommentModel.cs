        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepliedToUserId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Users_RepliedToUserId",
                        column: x => x.RepliedToUserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_RepliedToUserId",
                table: "Comments",
                column: "RepliedToUserId");
